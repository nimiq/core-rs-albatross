...
use nimiq::consensus::base::primitive::{hash::Blake2bHash, Address};
...
fn it_can_deserialize_block_108273() {
    ...
    if let Option::Some(ref body) = block.body {
        ...
        assert_eq!(body.transactions[0].value, Coin(3300000));
        ...
        assert_eq!(body.transactions[1].value, Coin(837520));
