...
use algebra::{AffineCurve, BigInteger384, PrimeField};
...
// The max is inclusive, we do tolerate MAX_NON_SIGNERS
pub const MAX_NON_SIGNERS: usize = (VALIDATOR_SLOTS - 1) / 3;
