...
use crate::circuits::mnt6::PKTree2Circuit;
...
type TheProofSystem = Groth16<MNT6_753, PKTree2Circuit, Fr>;
...
impl ConstraintSynthesizer<MNT4Fr> for PKTree1Circuit {
