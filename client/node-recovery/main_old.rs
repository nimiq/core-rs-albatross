...
fn get_upgradable_read(
    blockchain: &BlockchainProxy,
) -> Result<RwLockUpgradableReadGuard<Blockchain>, NodeRecoveryError> {
    match blockchain {
        BlockchainProxy::Full(blockchain) => Ok(blockchain.upgradable_read()),
        BlockchainProxy::Light(_) => Err(NodeRecoveryError::RevertingBlocksError(
