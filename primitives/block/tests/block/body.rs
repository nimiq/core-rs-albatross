...
use account::{Account, AccountType, PrunedAccount, VestingContract};
...
const B67795_BODY: &str = "";
...
fn it_can_deserialize_b169500_body() {
    ...
    assert_eq!(body.pruned_accounts.len(), 1);
    ...
    assert_eq!(body.pruned_accounts[0].address, Address::from("ad8e224835e6cc0cadbcf500a49dae46f6769704"));
    assert_eq!(body.pruned_accounts[0].account.balance(), Coin::ZERO);
    assert_eq!(body.pruned_accounts[0].account.account_type(), AccountType::HTLC);
}
...
fn verify_rejects_unordered_pruned_accounts() {
    ...
    body.pruned_accounts.push(account);
    assert_eq!(body.verify(169500, NetworkId::Main), Err(BlockError::PrunedAccountsNotOrdered));
}
...
fn verify_rejects_invalid_pruned_accounts() {
    ...
    assert_eq!(body.verify(169500, NetworkId::Main), Err(BlockError::InvalidPrunedAccount));
}
