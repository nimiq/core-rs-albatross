...
/// Bytes the Amoy program reads: 20 address + 32-byte nonce word + 32-byte amount word.
const AMOY_LAYOUT_LEN: usize = 84;
...
/// A well-formed 84-byte `TokensBurned` record for the Amoy program: one NIM, nonce 1.
