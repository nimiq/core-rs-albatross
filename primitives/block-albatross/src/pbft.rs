...
impl PbftProofBuilder {
    ...
    pub fn verify(&self, block_hash: Blake2bHash, _validators: &Validators, threshold: u16) -> Result<(), AggregateProofError> {
        ...
        // TODO sum up votes of signers that signed prepare and commit
