...
use nimiq_blockchain::{
    interface::HistoryInterface, BlockProducer, Blockchain, PostValidationHook,
};
use nimiq_blockchain_interface::{
    AbstractBlockchain, BlockchainEvent, ForkEvent, PushError, PushResult,
};
...
pub(crate) struct BlockPublisher<TValidatorNetwork: ValidatorNetwork> {
    pub(crate) network: Arc<TValidatorNetwork>,
}
