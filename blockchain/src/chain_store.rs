...
declare_table!(ChainTable, "ChainData", Blake2bHash => ChainInfoWrapper);
declare_table!(BlockTable, "Block", u64 => HeaderlessBlock);
...
impl ChainStore {
    ...
    pub fn put_chain_info(
        ...
        let last_block_index = cursor.last().map(|(key, _)| key);
