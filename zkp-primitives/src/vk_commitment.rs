...
pub fn vk_commitment<E: FixedPairing + DefaultPedersenParameters95>(
    vk: &VerifyingKey<E>,
) -> [u8; 95] {
...
pub fn non_native_vk_commitment<CP: FixedPairing + DefaultPedersenParameters95, P: FixedPairing>(
    vk: &VerifyingKey<P>,
) -> [u8; 95]
where
...
pub fn vks_commitment<E: FixedPairing + DefaultPedersenParameters95>(
    commitments: &[[u8; 95]],
) -> [u8; 95] {
