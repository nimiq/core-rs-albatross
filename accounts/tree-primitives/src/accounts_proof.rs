...
mod tests {
     ...
     */
        ...
        let account1 = Account::Basic(BasicAccount { balance: Coin::try_from(25).unwrap() });
        ...
        let account2 = Account::Basic(BasicAccount { balance: Coin::try_from(1).unwrap() });
        ...
        let account3 = Account::Basic(BasicAccount { balance: Coin::try_from(1322).unwrap() });
        ...
        let account4 = Account::Basic(BasicAccount { balance: Coin::try_from(93).unwrap() });
