...
impl MempoolAlbatrossHandler {
    ...
    fn build_validator_signalling_transaction(
        &self,
        sender: Address,
        ...
        proof_builder
            .generate()
            .ok_or_else(|| object! {"message" => "Failed to construct transaction"})
    }
    ...
    pub(crate) fn unstake(&self, params: &[JsonValue]) -> Result<JsonValue, JsonValue> {
        ...
        let proof =
            OutgoingStakingTransactionProof::Unstake(wallet_account.create_signature_proof(&tx));
