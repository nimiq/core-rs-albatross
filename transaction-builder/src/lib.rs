...
impl TransactionBuilder {
    ...
    pub fn new_retire_validator(
        ...
        let mut recipient = Recipient::new_staking_builder(staking_contract);
        recipient.retire_validator(&validator_id, &validator_key_pair.public_key);
    ...
    pub fn new_reactivate_validator(
        ...
        let mut recipient = Recipient::new_staking_builder(staking_contract);
        recipient.reactivate_validator(&validator_id, &validator_key_pair.public_key);
    ...
    pub fn new_unpark_validator(
        ...
        let mut recipient = Recipient::new_staking_builder(staking_contract);
        recipient.unpark_validator(&validator_id, &validator_key_pair.public_key);
