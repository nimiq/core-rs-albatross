...
fn compute_crc32() {
    ...
    crc32_comp = Crc32Computer::default();
    let a: [u8; 43] = [
        84, 104, 101, 32, 113, 117, 105, 99, 107, 32, 98, 114, 111, 119, 110, 32, 102, 111, 120, 32, 106, 117, 109, 112, 115, 32, 111, 118, 101, 114, 32, 116,
...
fn compute_crc8() {
    ...
    crc8_comp = Crc8Computer::default();
    let a: [u8; 32] = [
        169, 203, 76, 129, 160, 230, 129, 141, 117, 240, 195, 239, 197, 18, 196, 30, 26, 52, 253, 1, 21, 81, 249, 22, 234, 115, 246, 14, 62, 197, 228, 223,
    ];
    crc8_comp.update(&a);
