...
fn it_can_register_notify_deregister() {
    ...
    let handle1 = notifier.register(move |e: &u32| *event1_rc2.write().unwrap() = *e);
    ...
    let handle3 = notifier.register(move |e: &u32| *event3_rc2.write().unwrap() = *e);
    ...
    let handle5 = notifier.register(move |e: &u32| *event5_rc2.write().unwrap() = *e);
