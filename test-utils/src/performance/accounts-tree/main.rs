...
fn accounts_tree_populate(
    ...
    println!("Generating accounts and transactions...");
    // Generate accounts
    ...
    println!("Done generating {} transactions and accounts", txn_index);
...
fn main() {
    ...
    for loop_number in 1..(1 + loops) {
        ...
        accounts_tree_populate(&env, args.tpb, args.batches, loop_number, db_file.clone());
    }
