 ...
 */
export type PlainTransactionProof = ({ type: "empty" } & PlainEmptyProof) | ({ type: "standard" } & PlainStandardProof) | ({ type: "regular-transfer" } & PlainHtlcRegularTransferProof) | ({ type: "timeout-resolve" } & PlainHtlcTimeoutResolveProof) | ({ type: "early-resolve" } & PlainHtlcEarlyResolveProof);

/**
 * Placeholder struct to serialize an empty proof of transactions
 */
export interface PlainEmptyProof {}
...
*/
  getTransactionReceiptsByAddress(address: Address | string | Uint8Array, limit?: number, min_peers?: number): Promise<PlainTransactionReceipt[]>;
/**
...
* @returns {Promise<PlainTransactionDetails[]>}
*/
  getTransactionsByAddress(address: Address | string | Uint8Array, since_block_height?: number, known_transaction_details?: PlainTransactionDetails[], limit?: number, min_peers?: number): Promise<PlainTransactionDetails[]>;
}
/**
...
*/
  static unserialize(bytes: Uint8Array): ES256Signature;
/**
...
* @returns {Signature}
*/
  static unserialize(bytes: Uint8Array): Signature;
/**
* Serializes the signature to a byte array.
* @returns {Uint8Array}
*/
...
export interface InitOutput {
  ...
  readonly __wbg_cryptoutils_free: (a: number) => void;
  ...
  readonly es256signature_unserialize: (a: number, b: number, c: number) => void;
  ...
  readonly signature_unserialize: (a: number, b: number, c: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4466a655251171b2: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6e28ae36edfc2881: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h328dfb6e23a18358: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h0ac735bdcc461a94: (a: number, b: number, c: number, d: number) => void;
}
