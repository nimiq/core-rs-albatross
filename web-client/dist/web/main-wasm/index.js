...
const BLSKeyPairFinalization = new FinalizationRegistry(ptr => wasm.__wbg_blskeypair_free(ptr >>> 0));
/**
* A BLS keypair
...
const BLSPublicKeyFinalization = new FinalizationRegistry(ptr => wasm.__wbg_blspublickey_free(ptr >>> 0));
/**
    ...
    */
    static unserialize(bytes) {
        try {
            ...
            const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.blspublickey_unserialize(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
const BLSSecretKeyFinalization = new FinalizationRegistry(ptr => wasm.__wbg_blssecretkey_free(ptr >>> 0));
/**
...
const ES256PublicKeyFinalization = new FinalizationRegistry(ptr => wasm.__wbg_es256publickey_free(ptr >>> 0));
/**
...
const ES256SignatureFinalization = new FinalizationRegistry(ptr => wasm.__wbg_es256signature_free(ptr >>> 0));
/**
...
export class ES256Signature {
    ...
    */
    static fromBytes(bytes) {
        try {
            ...
            const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.es256signature_fromBytes(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    toBytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.es256signature_toBytes(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1, 1);
...
export class Hash {
    ...
    * @returns {Uint8Array}
    */
    static computeArgon2d(data) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.hash_computeArgon2d(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v2 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1, 1);
...
const MerklePathFinalization = new FinalizationRegistry(ptr => wasm.__wbg_merklepath_free(ptr >>> 0));
/**
...
export class MerklePath {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_merklepath_free(ptr);
    }
    /**
    ...
    * @returns {MerklePath}
    */
    static compute(values, leaf_value) {
        try {
            const ptr0 = passArrayJsValueToWasm0(values, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.merklepath_compute(ptr0, len0, addBorrowedObject(leaf_value));
    ...
    * @returns {Uint8Array}
    */
    computeRoot(leaf_value) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.merklepath_computeRoot(retptr, this.__wbg_ptr, addBorrowedObject(leaf_value));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1, 1);
...
const MerkleTreeFinalization = new FinalizationRegistry(ptr => wasm.__wbg_merkletree_free(ptr >>> 0));
/**
...
const SignatureProofFinalization = new FinalizationRegistry(ptr => wasm.__wbg_signatureproof_free(ptr >>> 0));
/**
...
export class SignatureProof {
    ...
    * @param {MerklePath} merkle_path
    */
    set merklePath(merkle_path) {
        _assertClass(merkle_path, MerklePath);
        var ptr0 = merkle_path.__destroy_into_raw();
        wasm.signatureproof_set_merklePath(this.__wbg_ptr, ptr0);
    }
    /**
...
const TransactionBuilderFinalization = new FinalizationRegistry(ptr => wasm.__wbg_transactionbuilder_free(ptr >>> 0));
/**
...
export class TransactionBuilder {
    ...
    * @returns {Transaction}
    */
    static newStake(sender, staker_address, value, fee, validity_start_height, network_id) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(sender, Address);
            _assertClass(staker_address, Address);
            wasm.transactionbuilder_newStake(retptr, sender.__wbg_ptr, staker_address.__wbg_ptr, value, !isLikeNone(fee), isLikeNone(fee) ? BigInt(0) : fee, validity_start_height, network_id);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    * @returns {Transaction}
    */
    static newUnstake(recipient, value, fee, validity_start_height, network_id) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(recipient, Address);
            wasm.transactionbuilder_newUnstake(retptr, recipient.__wbg_ptr, value, !isLikeNone(fee), isLikeNone(fee) ? BigInt(0) : fee, validity_start_height, network_id);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    * @returns {Transaction}
    */
    static newSetInactiveStake(sender, new_inactive_balance, fee, validity_start_height, network_id) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(sender, Address);
            wasm.transactionbuilder_newSetInactiveStake(retptr, sender.__wbg_ptr, new_inactive_balance, !isLikeNone(fee), isLikeNone(fee) ? BigInt(0) : fee, validity_start_height, network_id);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
