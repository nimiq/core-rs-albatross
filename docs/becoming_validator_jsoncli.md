...
configured to validate (check [this guide](becoming_validator#22-configure) to setup you client).
...
1. Use the response to get the data of your validator with the following command:
