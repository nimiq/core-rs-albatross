...
use block_albatross::Message;
use block_albatross::{
    IndividualSignature, MultiSignature, SignedViewChange, ViewChange, ViewChangeProof,
};
...
fn test_view_change_single_signature() {
    ...
    let aggregated_multi_sig = IndividualSignature::new(signed_message.signature, 0).as_multisig();
    let view_change_proof: ViewChangeProof = ViewChangeProof {
        sig: aggregated_multi_sig,
    };
...
// TODO Re-introduce for Tendermint
// #[test]
