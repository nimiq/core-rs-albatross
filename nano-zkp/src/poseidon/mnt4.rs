...
impl DefaultPoseidonParameters for Fq {
    const PARAMS_T3: PoseidonDefaultParametersEntry = PoseidonDefaultParametersEntry::new(2, 13, 8, 36, 0);
    const PARAMS_T9: PoseidonDefaultParametersEntry = PoseidonDefaultParametersEntry::new(8, 13, 8, 36, 0);
}
